...
const modalContent = {
  ...
  Chest: {
    title: "💁‍♀️ About Me",
    content:
      "I’m Krishal, an aspiring full-stack developer currently pursuing B.Tech and building my skills one project at a time. I started my web development journey recently, and since then I’ve worked with HTML, CSS, JavaScript, React, Tailwind, Node.js, Express, MongoDB, and TypeScript.In the sections ahead, you’ll find some of my recent projects—from frontend experiments to full MERN applications. I’m continuously learning, improving, and gearing up to build bigger, more scalable apps in the future.Outside of code, I like drawing, watching anime, and sometimes attempting cool character sketches (even if I redo them later 😅).If you want to talk tech, collaborate, or just chat, feel free",
  },
  Picnic: {
    title: "🍷 Uggh yesss 🧺",
    content:
